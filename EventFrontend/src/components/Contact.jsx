...
const Contact = () => {
  ...
  const openWhatsApp = () => {
    // Replace 'your-message' with your custom message    https://wa.link/vaoae6
    window.open("https://wa.link/7uhmnc", "_blank");
  };
        ...
        <div className="banner">
          ...
          <div className="item">
            <form onSubmit={handleSendMessage}>
             ...
             <button type="button" onClick={openWhatsApp} style={{ background: "transparent", border: "none", padding: 0 }}>
  <img
    src="wp.png" // Replace with your WhatsApp icon image
    alt="WhatsApp Icon"
